...
import { isB06BDelivered, isB08Delivered, isP04Delivered } from './app3-accepted-surface.mjs';
...
export function checkApp3B01NArtifacts(rootDir, fail) {
  ...
  const afterP04 = isP04Delivered(rootDir);
