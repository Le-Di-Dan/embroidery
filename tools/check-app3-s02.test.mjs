...
describe('the capabilities S02 must not grow', () => {
  ...
  it('refuses a runtime watermark', () => {
    const root = rootWith({
      [`${FEATURE}/components/studio-watermark.tsx`]: 'export const watermark = () => null;',
    });
    assert.ok(mentions(failuresOf(checkNonScope, root), 'APP3-S09'));
  });
