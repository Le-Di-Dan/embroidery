...
export function checkDesignApproval(rootDir, fail) {
   ...
   * for no others.
   */
  for (const claimed of foreignApprovals(registry, 'APP3-S01', Object.keys(S01_DESIGN_ROWS))) {
    fail(`${CANONICAL_FILES.registry}: ${claimed} was approved as APP3-S01 evidence`);
  }
}
