/**
 * The secure deposit-payment capability (`APP7-S01`).
 *
 ...
 * `APP5-S02` and `APP6-S01` keep theirs — these sentences are the approved
 * wording for this one route, not a shared string table, and a payment sentence
 * borrowed by another screen is a payment claim made in the wrong place.
 */
export { SecureDepositScreen } from './ui/secure-deposit-screen';
