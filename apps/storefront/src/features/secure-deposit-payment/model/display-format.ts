 ...
 *
 * They live apart from `exact-deposit-amount.ts` deliberately. That module is
 ...
 *
 * Neither function is ever applied to `depositAmount`, and neither is exported
 * to anything that handles one.
 */

/**
 * A server-measured byte count, for reading (`748:51`, `748:78`).
 *
...
/**
 * An ISO instant in the approved `dd/MM/yyyy HH:mm` form (`748:78`, `745:389`).
 *
