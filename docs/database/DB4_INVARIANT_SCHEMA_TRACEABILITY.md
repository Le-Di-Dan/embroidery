...
| INV-22 watermark on customer previews | asset_derivatives.is_watermarked + kind | CST-018 / **CST-126** | REL-047 | LC-06 | representation + **partial CK** (APP2-DB01) | APP derivative rules; **DB** for PREVIEW_WATERMARKED / CATALOG_PREVIEW | D7 catalog-preview suite | — | MOCKUP/NORMALIZED/THUMBNAIL remain APP-only |
