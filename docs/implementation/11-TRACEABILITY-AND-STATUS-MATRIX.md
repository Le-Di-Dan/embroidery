...
Current values are recorded once, in [`10-MASTER-APPLICATION-ROADMAP.md`](./10-MASTER-APPLICATION-ROADMAP.md) §6, and are not duplicated here. As of APP1-B01: **APP0 = `COMPLETE`** (evidence [`reports/APP0-X01-COMPLETION-REPORT.md`](./reports/APP0-X01-COMPLETION-REPORT.md)), **APP1 = `ENGINEERING_IN_PROGRESS`** (`APP1-DEC-AUTH` complete — staff auth IMP-D027; `APP1-D01` `DELIVERED_FOR_HUMAN_REVIEW` — [`APP1-D01-COMPLETION-REPORT.md`](./reports/APP1-D01-COMPLETION-REPORT.md), registry [`FIGMA_DESIGN_INDEX.md`](../design/FIGMA_DESIGN_INDEX.md); **`APP1-B01` `COMPLETE`** — staff session authentication, two endpoints, no migration, [`APP1-B01-COMPLETION-REPORT.md`](./reports/APP1-B01-COMPLETION-REPORT.md); next `APP1-B02` `READY`, `APP1-A01/A02/S01` `BLOCKED_BY_DESIGN_APPROVAL`), APP2–APP12 = `NOT_STARTED`.
