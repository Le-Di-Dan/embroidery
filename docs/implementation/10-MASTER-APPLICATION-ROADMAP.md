...
| APP1 | `READY_FOR_ENGINEERING` — **not started** | Unblocked by APP0 closure; pre-implementation audit complete. Plan: [`phases/APP1-STAFF-ACCESS-AND-SHELLS.md`](./phases/APP1-STAFF-ACCESS-AND-SHELLS.md); audit: [`audits/APP1_PRE_IMPLEMENTATION_AUDIT.md`](./audits/APP1_PRE_IMPLEMENTATION_AUDIT.md); report: [`reports/APP1-PRE-IMPLEMENTATION-AUDIT-COMPLETION-REPORT.md`](./reports/APP1-PRE-IMPLEMENTATION-AUDIT-COMPLETION-REPORT.md). First checkpoint `APP1-DEC-AUTH` = `READY`, not started; others `NOT_STARTED`. Closure owner for milestone **R0**. |
