...
> `APP1-B02` is **COMPLETE** (current staff `GET /api/staff/me`; report
> `../reports/APP1-B02-COMPLETION-REPORT.md`; `NO_MIGRATION_REQUIRED`). The frontend
