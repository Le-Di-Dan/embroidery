...
- **APP0-T02B — Browser E2E harness** *(testing foundation; dep: DEC-E2E, S01B, B03)* — **READY, NOT STARTED**.
  - Goal: run through the real gateway; disposable environment; one foundation smoke journey. No product feature journey. Handoff contract in the DEC-E2E report §F.
