...
APP3-S06 PLACEMENT = ASPECT_PRESERVED + CENTRED_IN_AREA + NEVER_UPSCALED — the operator-approved deterministic fallback, ruled on by APP3-P02 and refused rather than clamped when it does not fit
