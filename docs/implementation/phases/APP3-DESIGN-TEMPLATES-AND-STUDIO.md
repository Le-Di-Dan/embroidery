...
FU-APP3-S04-GROUP-AUTHORITY-01 = OPEN — group and ungroup need a Product Owner ruling on the persisted group frame and pivot (IMP-D045 PO-07/PO-12) and an approved member-selection interaction, before any checkpoint can implement them
