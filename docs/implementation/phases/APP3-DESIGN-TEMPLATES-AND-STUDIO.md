...
FU-APP3-DESIGN-TEMPLATE-FILE-SIZE-01 = OPEN — OWNER_NOT_YET_ASSIGNED — admin-design-template.controller.ts and drizzle-design-template.repository.ts were already 455 and 494 lines at B03B entry, over the CLAUDE.md §6 hard maximum of 400; B03B added 68 and 69 lines to reach 523 and 563. Splitting them is a refactor across four checkpoints' surfaces (B03/B03A/B03B/B04) and is not B03B's to make; recorded rather than silently inherited
...
NEXT_ELIGIBLE_FRONTEND_CHECKPOINTS = APP3-A04
...
APP3-D01 APPROVAL_RULE = SATISFIED — the 21 rows A01/A02/A03 need are APPROVED_FOR_IMPLEMENTATION; A04 and every Studio row stay REVIEW_REQUIRED until their own checkpoints open
