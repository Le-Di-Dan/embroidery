...
| APP3 | Design Studio spec, product requirements, lifecycle, security/abuse prevention | System architecture, frontend/backend conventions | Template/design-session/version/document guards and queries; Design System and Studio Figma artifacts |
